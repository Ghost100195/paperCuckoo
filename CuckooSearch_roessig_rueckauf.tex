...
\begin{document}
  ...
  \begin{abstract}
    ...
    wird in dem Algorithmus durch den Lévy Flight erzeugt. Dieser erzeugt ein Bewegungsmuster wie es bei einigen Vögeln und Insekten 
  ...
  \section{Anpassung des Cuckoo Search für die betrachteten Probleme}
    ...
    \subsection{Cuckoo Search für das Sequential Ordering Problem}
      ...
      Im Folgenden werden drei Varianten vorgestellt, die den Umgang mit inkorrekten Reihenfolgen auf unterschiedliche
      Art lösen. Anschließend wird die Implementierung einer dieser Varianten für den CS gezeigt. 
    ...
    \subsection{Operatoren} 
      ...
      nur noch korrekte Ergebnisse erzeugen. Die beiden Operatoren des CS besitzen eine einfache 
    ...
    \subsection{Reparierung}
      ...
      Des Weiteren ist der \textit{Repair-Schritt} ein unnatürlicher Eingriff in die natürliche Lösungsfindung des CS, 
    ...
    \subsection{Implementierung} \label{Implementierung Repair}
      Im CS, muss an drei Orten festgestellt werden, dass nur korrekte Reihenfolgen erstellt werden. 
      ...
      transformiert, dass sie dem SOP entsprechen. Der \textit{2-Opt-move} kann zu invaliden Reihenfolgen führen, muss dies aber 
  ...
  \section{Evaluierung}
    ...
    Dabei untersuchen wir verschiedene Anzahlen an Nester und Iterationen sowie unterschiedliche Wahrscheinlichkeiten $P_a$ dafür, dass ein 
    Ei entdeckt wird und aus dem Nest geworfen wird. Die Ergebnisse werden anschließend genutzt um den CS auf mehreren 
    ...
    \subsection{Parameter}
      ...
      gemacht. Hierbei wurden eine $P_a$ von 0.15 und 1000 Generationen genutzt. Die Ergebnisse (Abb. \ref{fig:nests}) zeigen, dass mit steigerender Anzahl 
      der Nester wieder ein schnelleres Anpassungsverhalten vorliegt, welches aber wiederrum mit ansteigender Anzahl an Generationen verschwindet. Damit hat die Anzahl der Nester auch wieder
      ...
      In Abbildung \ref{fig:generation} ist der Einfluss des Generationen Parameters zu erkennen. Für den Durchlauf wurden 50 Nester und ein $P_a$ von 0.15 genutzt. 
	...
	\renewcommand{\arraystretch}{1.5}
      ...
      Für kleine TSP erbringt der CS gute Ergebnisse in linearer Zeit. Hingegen in der Tabelle auch zu erkennen, dass 
      mit wachsender Anzahl an Knoten, das Ergebnis immer schlechter wird. Für den Datensatz \textit{d1291} beträgt der Abstand zwischen 
      dem besten und den vom CS erzeugten Ergebnis $222502 - 50801 = 171701$. Das bedeutet, dass der CS mehr als $3x$ vom besten Ergebnis 
      abweicht, was enorm ist. Bei kleineren TSP's performt der Algorithmus hingegen gut. 
      ...
      eingeschätzt werden kann, eignet sich der CS nicht für das SOP.
