...
\begin{document}
      ...
      \begin{algorithm}
        ...
        \While{($i <$ $n$)}
          ...
          \While{($y <$ $n$)}
            ...
            \EndIf
          \EndWhile
          \State Erhöhe $i$ um 1, falls innere Schleife nicht abgebrochen wurde
        \EndWhile
  ...
  \section{Evaluierung}
    ...
    \subsection{Ergebnisse}
      Im folgenden werden SOP sowie TSP Probleme anhand von Datensätzen vom (xy-Uni.blabla) getestet. Dabei werden die Parameter
      aus den vorherigen Abschnitt genutzt. 
      Für die Erfassung der Werte wurden jeweils 10 Durchläufe gemacht und anschließend der Mittelwert gebildet.
